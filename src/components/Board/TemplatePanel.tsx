...
export const ANIMATED_DECOR_ITEMS: Array<{ id: DecorKind; label: string; color: string }> = [
  ...
  { id: 'pulseGrid', label: 'Матрица', color: '#4ade80' },
  { id: 'scanRing', label: 'Скан-кольцо', color: '#2dd4bf' },
  { id: 'bounceArrow', label: 'Указатель', color: '#fbbf24' },
  { id: 'typingCaret', label: 'Курсор', color: '#e8eae6' },
  { id: 'signalBars', label: 'Приём', color: '#4ade80' },
  { id: 'hourglass', label: 'Песочные', color: '#fbbf24' },
  { id: 'battery', label: 'Заряд', color: '#4ade80' },
  { id: 'satellite', label: 'Антенна', color: '#2dd4bf' },
  { id: 'crosshairLock', label: 'Захват', color: '#f97316' },
  { id: 'barcodeScan', label: 'Сканер кода', color: '#e8eae6' },
  { id: 'dnaHelix', label: 'Спираль', color: '#2dd4bf' },
  { id: 'compass', label: 'Компас', color: '#fbbf24' },
  { id: 'magnet', label: 'Магнит', color: '#f97316' },
  { id: 'hexPulse', label: 'Гекс-пульс', color: '#2dd4bf' },
  { id: 'sparkFlicker', label: 'Искра', color: '#fbbf24' },
  { id: 'metronome', label: 'Метроном', color: '#e8eae6' },
  { id: 'elevator', label: 'Подъём', color: '#4ade80' },
  { id: 'clickRipple', label: 'Клик', color: '#e8eae6' },
  { id: 'shieldScan', label: 'Защита', color: '#2dd4bf' },
  { id: 'countdownRing', label: 'Таймер', color: '#f97316' },
]
